...
import { YouTubeIcon, ErrorIcon } from './icons';
    ...
    return (
        <div className="flex flex-col w-full h-full bg-slate-900/20 overflow-hidden items-center justify-center p-8 text-center">
            <div className="relative w-40 h-40 flex items-center justify-center mb-6">
                ...
                <YouTubeIcon className="relative w-28 h-28 text-slate-400" />
            </div>
            <h1 className="text-2xl font-bold text-slate-200 mb-3">EduTube Feature Disabled</h1>
